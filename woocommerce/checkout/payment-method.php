...
?>
<div class="method-item method-paypal wc_payment_method payment_method_<?php echo esc_attr($gateway->id); ?> method-paypal">
    <label for="payment_method_<?php echo esc_attr($gateway->id); ?>">
        <?php echo $gateway->get_title(); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?>
        <div class="input-field-wrapp disabled check-input input-payment">
            <input id="payment_method_<?php echo esc_attr($gateway->id); ?>" type="radio"
                   class="input-radio input-field" name="payment_method"
